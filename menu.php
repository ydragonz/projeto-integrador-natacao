<div class="position-sticky pt-3">
    <ul class="nav flex-column">
        ...
        <li class="nav-item">
            <a class="nav-link text-white" href="?p=convenios/index.php">
        ...
        <li class="nav-item">
            <a class="nav-link text-white" href="?p=atletas/index.php">
        ...
        <li class="nav-item">
            <a class="nav-link text-white" href="?p=telefones/index.php">
        ...
        <li class="nav-item">
            <a class="nav-link text-white" href="?p=alergias/index.php">
        ...
        <li class="nav-item">
            <a class="nav-link text-white" href="?p=empregos/index.php">
        ...
        <?php } ?>
        <li class="nav-item">
            <a class="nav-link text-white" href="?p=provas/index.php">
